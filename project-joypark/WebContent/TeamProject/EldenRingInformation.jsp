...
<head>
    ...
    <link rel="stylesheet" href="css/EldenringInfo.css">
    <link rel="stylesheet" href="css/header.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.6.1/dist/css/bootstrap.min.css">
    <script src="https://cdn.jsdelivr.net/npm/jquery@3.6.0/dist/jquery.slim.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/popper.js@1.16.1/dist/umd/popper.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.1/dist/js/bootstrap.bundle.min.js"></script>
    <script type="text/javascript" src="jsfolder/InfoHeader.js?ver=1"></script>
</head>
<body>
    <div id="header">
        <a href="MainPage.jsp"><img src="image/Alogo.png" width=70px height=70px></a><h2>| GAME</h2>
    </div>
    <div id="Category">
        <img src="css/image/EldenRingLogo.png" width=150px height=70px><div id="ScrollForCon"><a id="summary">게임 개요</a><a id="feature">게임 특징</a><a id="systemRequire">시스템 요구사항</a></div>
    </div>
    <div id="FirstSection">
    ...
    <div id="ThreeSection">
        ...
        <div id="ThreeSectionImages">
            ...
            <img src="css/image/eldenringThreeSection1.jpg" width="300" height="200">
            ...
            <img src="css/image/eldenringThreeSection2.jpg" width="300" height="200">
            ...
            <img src="css/image/eldenringThreeSection3.jpg" width="300" height="200">
