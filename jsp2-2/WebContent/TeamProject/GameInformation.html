...
<body>
    <div id="header">
        <a href="MainPage.html"><img src="image/Alogo.png" width=70px height=70px></a><h2>| GAME</h2>
    </div>
    <div id="InfoIndex">
        <img src="image/EldenRingLogo.png" width=150px height=70px><div id="ScrollForCon"><a>게임 개요</a><a>게임 특징</a><a>시스템 요구사항</a></div>
    </div>
    <div id="FirstSection">
    <div id="FirstInfoGrad">
        ...
        <h4 id="AvildDate">출시 2022년 02월 05일</h4>
        <div id="StackView">
            <img src="image/SoloPlay.png" width=30px height=30px><span>싱글 플레이</span>
            <img src="image/PartyPlay.png" width=40px height=40px><span>온라인 협동</span>
        </div>
        </div>
    </div>
    </div>
    <div id="slideShowBack">
        <div id="screenShots">
        <img src="image/eldenringSC.png" width="300" height="200">
        <img src="image/eldenringSC2.jpg" width="300" height="200">
        <img src="image/eldenringSC3.jpg" width="300" height="200">
        </div>
    </div>
    <div id="TwoSection">
    ...
    <div id="ThreeSection">
        ...
        <div id="ThreeSectionImages">
            ...
            <img src="image/eldenringThreeSection1.jpg" width="300" height="200">
            ...
            <img src="image/eldenringThreeSection2.jpg" width="300" height="200">
            ...
            <img src="image/eldenringThreeSection3.jpg" width="300" height="200">
